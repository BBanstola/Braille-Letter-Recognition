...
test_data = open((UPLOAD_FOLDER2)+"test.csv", 'r')
...
for record in test_list:
    ...
    if outputs[label] > 0.35:
        confidence = "High"
    print
    label, correct_label, confidence
...
with open(UPLOAD_FOLDER2+'nn.dill', 'wb') as f:
    dill.dump(neural, f)